...
def run_main(args):
    print('here')
    if args.dataset == 'huga':
        from daart_utils.session_ids.huga import SESS_IDS_TRAIN as sess_ids_list
    else:
    ...
    pre = args.pre
    n_labels_list = args.n_labels.split(';')
    ...
    for model_type in model_types:
        ...
        for n_lab in n_labels_list:
            
            n_sessions = 5
            sess_to_keep_list = sess_ids
            ...
            for s in range(args.n_samples):
                ...
                # base session
                base = "/home/bsb2144/daart_utils/data/huga/labels-hand/{}_labels.csv"
                new_v = "/home/bsb2144/daart_utils/data/huga/labels-hand/{}_{}_v{}_labels.csv"
                for train_sess in sess_ids:
                    shutil.copy(new_v.format(train_sess, n_lab, s+1), base.format(train_sess))
                ...
                # print(sess_ids)
                print('sess to keep', list(sess_to_keep))
                # modify configs
                update_config(
                ...
                update_config(
                    ...
                    '%s-%s-good_sample-%i_%s' % (pre, n_lab, s, input_type))
...
if __name__ == '__main__':
    ...
    # define numbers of labels, separated by a semi-colon, i.e. '0.2;0.4;1.0'
