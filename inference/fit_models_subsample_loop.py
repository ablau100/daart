...
grid_search_file = '/home/mattw/Dropbox/github/daart_utils/scripts/fit_models.py'
    ...
    for model_type in model_types:
        ...
        for frac in fracs:
            ...
            for s in range(args.n_samples):
                ...
                # modify configs
                update_config(
                    config_files['model'], 'backbone', model_type)
                update_config(
                ...
                update_config(
                    ...
                    '%i-good_sample-%i_%s' % (n_sessions, s, input_type))
